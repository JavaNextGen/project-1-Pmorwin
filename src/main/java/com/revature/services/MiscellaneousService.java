...
public class MiscellaneousService {
	...
	public void updateMiscellaneousStatus(Miscellaneous Miscellaneous) {
		mDAO.updateMiscStatus(Miscellaneous);
	}
	public void updateMiscellaneousStatus(int decision, int misc_id) {
